...
<head>
  ...
  <body>
	...
	<section class="page-header">
        <div class="container">
	        <h1 class="title-ucol">SISTEMA DE RESERVAS</h1>
		...
		<div>
				<center>
					...
					<form action="loguear.php" method="POST">
						<div style="background-color:#669934;color:#FFF;text-align:center;font-weight:bold; padding:2px; width: 280px" >LOGIN</div>
						<br>

						<?php 
							$id = $_GET['id'];
							if($id==1){
								echo "<label>Debes primero Iniciar Sesion</label>";
								echo "<br>";
							}
						?>
						...
						<br>
						<input style="width: 100px; height: 20px;" type="text" name="NoCuenta">
						<br><br>

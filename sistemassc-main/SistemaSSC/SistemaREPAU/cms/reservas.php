...
<head>
  ...
  <body>
	...
	<section class="page-header">
        <div class="container">
	        <h1 class="title-ucol">RESERVACIONES</h1>
	        <!-- aqui se debe imprimir el valor de $lugar/-->
	        <?php 
	        	include("adentro3.php");
	        ?>
	    </div><!--/ Cierra .container /-->
    </section>
   
     <left>
    <div style="background-color:#669934;color:#FFF;text-align:center;font-weight:bold; padding:2px; width: 230px; margin-left: 18px;" >DEPENDENCIAS</div>
    </left>
  ...
  <body>
    ...
    <table style="margin-top: -60px;" class="table table-hover table-dark table-fixed">
    	
       <thread>
        <tr style="width: 800px">
          <th style="width: 25px" scope="col">#</th>
          <th style="width: 150px" scope="col">NOMBRE</th>
          <th style="width: 150px" scope="col">No.CUENTA</th>
          <th style="width: 150px" scope="col">CORREO</th>
          <th style="width: 150px" scope="col">LUGAR</th>
          <th style="width: 175px" scope="col">FECHA</th>
          <th style="width: 95px" scope="col">HORA</th>
          <th style="width: 95px" scope="col">TIEMPO</th>
          <th style="width: 100px" scope="col">ELIMINAR</th>
        </tr>
      </thread>
      <tbody>
        
      	<?php require_once 'conseguir_datos.php' ?>
